...
<ul class="ulfancy">
  ...
  <li class="row<?php echo $i % 2; ?>">
    ...
    <div class="list-description">
      ...
      <a class="button edit" 
        href="index.php?content=categorydelete&cat_id=<?php echo $item->getCat_id(); ?>">Delete</a>
      <a class="button edit" 
        href="index.php?content=categorymaint&cat_id=<?php echo $item->getCat_id(); ?>">Edit</a>
    </div>
